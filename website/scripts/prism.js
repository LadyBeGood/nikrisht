/* PrismJS 1.30.0
 * https://prismjs.com/download#themes=prism&languages=clike+javascript 
 */

// minified prism.js core
...
// minified prism.js toolbar plugin (needed for copy-to-clipboard plugin)
...
// minified prism.js copy-to-clipboard plugin (customised for inserting relevant svg icons instead of text message)
!function(){function t(t){var e=document.createElement("textarea");e.value=t.getText(),e.style.top="0",e.style.left="0",e.style.position="fixed",document.body.appendChild(e),e.focus(),e.select();try{var o=document.execCommand("copy");setTimeout((function(){o?t.success():t.error()}),1)}catch(e){setTimeout((function(){t.error(e)}),1)}document.body.removeChild(e)}"undefined"!=typeof Prism&&"undefined"!=typeof document&&(Prism.plugins.toolbar?Prism.plugins.toolbar.registerButton("copy-to-clipboard",(function(e){var o=e.element,n=function(t){var e={copy:`
...
`,"copy-error":"Press Ctrl+C to copy","copy-success":`
...
Prism.languages.webmanifest = Prism.languages.nikrisht;
